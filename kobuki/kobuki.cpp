...
namespace kobuki {
template <size_t N> bool create_efds(std::array<int, N> &efds) {
...
template <typename T> T prepare_message(protocol::Command type) {
  T msg;
...
bool Kobuki::process_packet(const char *buffer, uint8_t length) {
  ...
  for (offset = 0; offset < length;) {
    ...
    case protocol::Feedback::BasicSensorData:
      ret = on_msg(
          *reinterpret_cast<const protocol::BasicSensorData *>(subpayload));
      break;
    ...
    case protocol::Feedback::InertialSensor:
      ret = on_msg(
          *reinterpret_cast<const protocol::InertialSensorData *>(subpayload));
      break;
    case protocol::Feedback::Cliff:
      ret = on_msg(
          *reinterpret_cast<const protocol::CliffSensorData *>(subpayload));
      break;
    ...
    case protocol::Feedback::HardwareVersion:
      ret = on_msg(
          *reinterpret_cast<const protocol::HardwareVersion *>(subpayload));
      break;
    case protocol::Feedback::FirmwareVersion:
      ret = on_msg(
          *reinterpret_cast<const protocol::FirmwareVersion *>(subpayload));
      break;
    case protocol::Feedback::Reserved_5:
      break;
    case protocol::Feedback::RawData3AxisGyro:
      ret = on_msg(
          *reinterpret_cast<const protocol::RawData3AxisGyro *>(subpayload));
      break;
    ...
    case protocol::Feedback::GeneralPurposeInput:
      ret = on_msg(
          *reinterpret_cast<const protocol::GeneralPurposeInput *>(subpayload));
      break;
    case protocol::Feedback::Reserved_8:
    case protocol::Feedback::Reserved_9:
      break;
    case protocol::Feedback::UDID:
      ret = on_msg(*reinterpret_cast<const protocol::UniqueDeviceIdentifier *>(
          subpayload));
      break;
    ...
    case protocol::Feedback::ControllerInfo:
      ret = on_msg(
          *reinterpret_cast<const protocol::ControllerInfo *>(subpayload));
      break;
    default:
...
template <typename T> void Kobuki::send_msg(const T &msg) {
...
void Kobuki::set_leds(bool led_1_green, bool led_1_red, bool led_2_green,
                      bool led_2_red) {
...
bool Kobuki::on_msg(const protocol::BasicSensorData &basic_sensor_data) {
  ...
  basic_data.buttons.set(0,
                         basic_sensor_data.button & protocol::Button::Button_0);
  basic_data.buttons.set(1,
                         basic_sensor_data.button & protocol::Button::Button_1);
  basic_data.buttons.set(2,
                         basic_sensor_data.button & protocol::Button::Button_2);
